...
function CreatePost() {
    ...
    const createPost = (event) => {
        setLoader(true)
        event.preventDefault();//stop the default behaviour of page reload form submit
    ...
    return (
        <div className="container">
            {isEdit ?
                <h3 className="text-center text-uppercase py-4">Edit Post</h3>
                :
                <h3 className="text-center text-uppercase py-4">Create Post</h3> 
            }
